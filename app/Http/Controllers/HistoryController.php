...
public function AddClickZalo (Request $request) 
{
        ...
        $client = new Client();
        $res = $client->request('post',"https://soida-api.placentor.com.vn/api/add-type-contact" , [
        'json' =>$dataUpdate
        ]   
        );
 ...
 public function addClickZalo2 (Request $request) 
{
         ...
         $client = new Client();
         $res = $client->request('post',"https://soida-api.placentor.com.vn/api/add-type-contact2" , [
         'json' =>$dataUpdate
         ]   
         );
          return  ["is_success" =>true];
