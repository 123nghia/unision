...
class HomepageController extends Controller
{
    ...
    {
        $checkacssSlugUrl ="https://soida-api.placentor.com.vn/api/check-access-slug";
        $client = new Client();

        $res = $client->request('post', 'https://soida-api.placentor.com.vn/api/check-access-slug', [
            'json' => [
                'slug'=> $slug
              ]
        ]);
...
public function getDataInfo (Request $request) 
{
    ...
    {  
        ...
        $url = "https://soida-api.placentor.com.vn/api/baner/getAllBannerWeb";
        $client = new Client();
        $res = $client->request('get', $url, $params);
    ...
    private function checkGameStatus($slug)
    {
        ...
        $url ="https://soida-api.placentor.com.vn/api/get-game-active";
        $client = new Client();
    ...
    private function getDataById($id)
    {
        ...
        $url ="https://soida-api.placentor.com.vn/api/getInfoUser?id=".$id;
        $client = new Client();
        $res = $client->request('get', $url, [
            'json' => [
                'id'=> $id
    ...
    private function getBeauty($slug)
    {
        ...
        $url ="https://soida-api.placentor.com.vn/api/gameBeauty/getInfo2?slug=".$slug;
        $client = new Client();
    ...
    private function getTuVan($slug)
    {
        ...
        $url ="https://soida-api.placentor.com.vn/api/tuvan/getInfo2?slug=".$slug;
        $client = new Client();
    ...
    private function getKLCT($companyId)
    {
        ...
        $client = new Client();
        $res = $client->request('post', 'https://soida-api.placentor.com.vn/api/paramenterRecomed/get-ket-luan-chi-tiet', [
            'json' =>$dataRequest
        ]);
    ...
    private function getGameXemtuong($companyId)
    {
        ...
        $url ="https://soida-api.placentor.com.vn/api/xemtuong/getInfoAdmin";
        $client = new Client();
    ...
    private function getGameMinisize($companyId)
    {
        ...
        $url ="https://soida-api.placentor.com.vn/api/minisize/getInfoAdmin";
        $client = new Client();
    ...
    public function skinIndex (Request $request, $slug ="soida") 
    {
    ...
    public function result (Request $request, $slug ="soida") 
    {
        ...
        return view("resultZalo", compact("slug", "resultKlCT",
    ...
    public function historyDetailPage3 (Request $request , $id =null) 
    {
        ...
        $slug = "";
        $checkacssSlugUrl ="https://soida-api.placentor.com.vn/api/get-detail-history-skin";
        $client = new Client();
        $res = $client->request('post', 'https://soida-api.placentor.com.vn/api/get-detail-history-skin', [
            'json' => [
                 'id'=> $id
              ]
        ]);
