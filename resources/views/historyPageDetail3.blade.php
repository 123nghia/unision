...
<div class="modal" id="signUpModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <div id="b-placeholder">
        ...
        <ul class="right-menu">
            ...
            <li class="right-text login">
                <a href=" https://soida.placentor.com.vn/" href="javascript:void(0)" data-toggle="modal"
...
{   
    ...
    ToggleDisplayLogin('.status-modal-account',true,'Để xem Nhật ký');
...
https://soida.placentor.com.vn/images/image1.png
if(dataFace)
{
switch(indexDraw) {
case 1:
