@php
    ...
    else 
    {
        ...
        $dataSeo->title ="Placentor Vegetal .Ngay tại nhà, Kiểm tra, tuổi da & hơn 40 thông số về da khác. Một lần quét, nói với bạn mọi điều .#soidaonline";
        $dataSeo->imageShare ="/images/tikitech_icon.png";
    }
    if($slug =="ngocdung")
    {
    
        $dataSeo-> title ="TMV Ngoc Dung Placentor Vegetal";
    }
    else if($slug =="zasaly")
    {
        $dataSeo-> title ="Zasaly Spa Placentor Vegetal";
    }
    else if($slug =="zema")
    {
        $dataSeo-> title ="Zema Beauty Placentor Vegetal";
    }
    else 
    {
        $dataSeo-> title ="Placentor Vegetal";
    }
    $fileCamera = "";
            ...
            <div class="ai-skin__skin">
                ...
                <div class="ai-skin-skin-body">
                    <div class="ai-skin__skin-image ai-skin__skin-image--inactive" id="skinImage">
                        <img class="ai-skin__skin-image__background" data-src=""
                            src="{{ $fileCamera }}">
          ...
          "
            ...
            <div class="nav-menu" id ="cammeraButton"  style ="display:none">
                 ...
                 <div class="uploadButton uploadImage">
                    ...
                    <div class="nav-avatar" onclick="choseImage()"  style="
...
<style>
    ...
    .dropdown-content {
        ...
        <script>
            ...
            var isTurnSound  = false;
            var fileSound = "/hdsd.m4a";
                    ...
                    <div class="slick-carousel mb-3">';
                        ...
                        for (let i = 0; i < listProduct.length; i++) {
                            ...
                            if (itemProduct.image_link.length > 0) {
                                imagelink = "https://soida-api.placentor.com.vn/public/image_plugin/" + itemProduct
                                    .image_link;
                            } else {
    ...
    <script>
        ...
        function choseImage() {
            if(!isLogin)
            {
                ToggleDisplayLogin('.status-modal-account',true,'Để tiếp tục soi da');
                return;
            }
