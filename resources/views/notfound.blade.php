...
<head>
    ...
    <title>Dữ liệu tìm không thấy</title>
...
<body>
     <div class="centerscreen"> 
        ...
        <h1>Tài khoản không tồn tại trong hệ thống, </h1> 
        <h1>Vui lòng liên hệ với admin</h1>
        <a hreft ="javascript:void(0)" >hoặc <a href="https://quanganh-admin.applamdep.com" target="_blank" class="impresColor">đăng ký</a> tài khoản nếu chưa có</a>
