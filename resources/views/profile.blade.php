    ...
    <div id="b-placeholder">
        ...
        <div class= "areaLogin">  
                ...
                <ul class="right-menu">
                    ...
                    <li class="right-text login">
                        <a href=" /" href="javascript:void(0)" data-toggle="modal" data-target="#signUpModal" >Đăng ký</a>
                    </li>
                </ul>   
        ...
        <script>
            var skinModule = (function () {
                ...
                function saveHistory(result) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "https://soida-api.placentor.com.vn/api/add-history-skin",
                        data: JSON.stringify({
                            "UserName": null,
                            "Result": result,
                            "User_Id": null,
                ...
                <div class="slick-carousel mb-3">';
                        ...
                        for (let i = 0; i < listProduct.length; i++) {
                            ...
                            if (itemProduct.image_link.length > 0) {
                                imagelink = "https://soida-api.placentor.com.vn/public/image_plugin/" + itemProduct.image_link;
                            } else {
