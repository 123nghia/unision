...
class EndUserv2 extends Component {
  ...
  getData = async () => {
    ...
    const res = await axios({
      baseURL: "https://soida-api.placentor.com.vn",
                  ...
                  <table ble className="table table-hover table-outline mb-0  d-sm-table">
                    <thead className="thead-light">
                      <tr>
                        ...
                        <th className="text-center">Công ty/shop</th>
                        <th className="text-center">Link soida</th>
                        <th className="text-center">Lượt soi da</th>
                    ...
                    <tbody>
                      <td colSpan="10" hidden={this.state.hidden} className="text-center">Không tìm thấy dữ liệu</td>
                      {
                        ...
                        data != undefined ?
                          data.map((item, i) => {
                            let datacompany = item.companyId;

                            if(datacompany.length >0)
                            {
                              datacompany = datacompany[0];
                             }
                             let hrefLink = "https://soida-api.placentor.com.vn/"+datacompany.Slug;
                             let hrefVievDetail ="https://admin.placentor.com.vn/#/historyskin/"+datacompany._id;
                            return (
                              <tr key={i}>
                                <td className="text-center">{i + 1}</td>
                                <td className="text-center">{datacompany.Name}</td>
                                 <td className="text-center"><a href={hrefLink} target ="_blank">Trang soi da </a></td>
                                <td className="text-center">{item.count}</td>
                                <td className="text-center"><a href={hrefVievDetail} target ="_blank">Chi tiết </a></td>
