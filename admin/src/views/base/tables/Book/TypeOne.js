          ...
          <Modal size="xl" isOpen={this.state.modalCom} className={this.props.className}>
            ...
            <TextFieldGroup
              ...
              />
              {
                this.state.image == "" ? "" :
                  <img width="250" height="300" src={
                    this.state.linkFiePdf_show == "" ? `https://soida-api.placentor.com.vn/public/image_plugin/${this.state.linkFiePdf_show}` : this.state.linkFiePdf} style={{ marginBottom: 20 }} />
              }
