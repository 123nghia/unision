...
class BrandSlider extends Component {
  ...
  getData = async () => {
    ...
    const res_brand = await axios({
      ...
      url: Constants.LIST_Banner_vendor,
      method: 'GET'
    });
  ...
  getData_Company = async () => {
    ...
    const res_brand = await axios({
      baseURL: Constants.BASE_URL,
      url: Constants.LIST_Banner_vendor + JSON.parse(this.state.user).company_id,
      method: 'GET'
    });
  ...
  async addBrand() {
    ...
    const res = await axios({
      baseURL: Constants.BASE_URL,
      url: Constants.ADD_Banner_vendor,
      method: 'POST',
      data: body
    });
  ...
  async updateBrand() {
    ...
    const res = await axios({
      baseURL: Constants.BASE_URL,
      url: Constants.UPDATE_Banner_vendor,
      method: 'POST',
      data: body
    });
  ...
  async delete() {
    ...
    const res = await axios({
      baseURL: Constants.BASE_URL,
      url: Constants.DELETE_Banner_vendor,
      method: 'POST',
      data: {
        "id": this.state.id
      }
