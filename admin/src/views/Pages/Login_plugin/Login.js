          ...
          <CRow className="justify-content-center">
            <CCol md="8">
              <CCardGroup>
                ...
                <CCard className="bg-primary d-md-down-none" style={{ width: '44%' }}>
                  <img style={{ alignSelf: 'center' }}  width="130px" src="/logo2.png" />
                  <CCardBody className="text-center">
                    <div className ="descriptionLogin">
                    
                      <span>Hãy để Placentor Vegetal chăm sóc làn da của bạn”
Ngay tại nhà, Kiểm tra & tư vấn, tuổi da & hơn 40 thông số về da khác</span>
<p>Một lần quét, nói với bạn mọi điều
</p>
                      <a href="https://soida-api.placentor.com.vn/dangky" target="_blank">
                        <CButton color="primary" className="mt-3" >Đăng ký ngay</CButton>
                      </a>
                    </div>
                  </CCardBody>
                </CCard>
